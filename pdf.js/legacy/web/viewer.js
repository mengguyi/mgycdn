...
function webViewerPageRendered(_ref6) {
  ...
  if (pageNumber === PDFViewerApplication.page) {
    ...
    (_PDFViewerApplication = PDFViewerApplication.toolbar) === null || _PDFViewerApplication === void 0 ? void 0 : _PDFViewerApplication.updateLoadingIndicatorState(false);
  }
  if (((_PDFViewerApplication2 = PDFViewerApplication.pdfSidebar) === null || _PDFViewerApplication2 === void 0 ? void 0 : _PDFViewerApplication2.visibleView) === _ui_utils.SidebarView.THUMBS) {
    var _PDFViewerApplication3;
    const pageView = PDFViewerApplication.pdfViewer.getPageView(pageNumber - 1);
    const thumbnailView = (_PDFViewerApplication3 = PDFViewerApplication.pdfThumbnailViewer) === null || _PDFViewerApplication3 === void 0 ? void 0 : _PDFViewerApplication3.getThumbnail(pageNumber - 1);
...
function webViewerPageMode(_ref7) {
  ...
  (_PDFViewerApplication4 = PDFViewerApplication.pdfSidebar) === null || _PDFViewerApplication4 === void 0 ? void 0 : _PDFViewerApplication4.switchView(view, true);
}
function webViewerNamedAction(evt) {
  var _PDFViewerApplication5;
  switch (evt.action) {
    case "GoToPage":
      (_PDFViewerApplication5 = PDFViewerApplication.appConfig.toolbar) === null || _PDFViewerApplication5 === void 0 ? void 0 : _PDFViewerApplication5.pageNumber.select();
      break;
    case "Find":
      if (!PDFViewerApplication.supportsIntegratedFind) {
...
function webViewerSidebarViewChanged(_ref8) {
  ...
  if (PDFViewerApplication.isInitialViewSet) {
    ...
    (_PDFViewerApplication6 = PDFViewerApplication.store) === null || _PDFViewerApplication6 === void 0 ? void 0 : _PDFViewerApplication6.set("sidebarView", view).catch(() => {});
  }
}
function webViewerUpdateViewarea(_ref9) {
  ...
  if (PDFViewerApplication.isInitialViewSet) {
    ...
    (_PDFViewerApplication7 = PDFViewerApplication.store) === null || _PDFViewerApplication7 === void 0 ? void 0 : _PDFViewerApplication7.setMultiple({
  ...
  (_PDFViewerApplication8 = PDFViewerApplication.toolbar) === null || _PDFViewerApplication8 === void 0 ? void 0 : _PDFViewerApplication8.updateLoadingIndicatorState(loading);
}
...
function webViewerPageChanging(_ref12) {
  var _PDFViewerApplication17, _PDFViewerApplication18, _PDFViewerApplication19;
  let {
    pageNumber,
    pageLabel
  } = _ref12;
...
function webViewerClick(evt) {
  var _PDFViewerApplication21, _appConfig$toolbar3, _appConfig$secondaryT3;
  ...
  if (cmd === 0) {
    ...
    switch (evt.keyCode) {
      ...
      case 35:
        ...
        break;
      case 83:
        (_PDFViewerApplication25 = PDFViewerApplication.pdfCursorTools) === null || _PDFViewerApplication25 === void 0 ? void 0 : _PDFViewerApplication25.switchTool(_pdf_cursor_tools.CursorTool.SELECT);
        break;
      case 72:
        (_PDFViewerApplication26 = PDFViewerApplication.pdfCursorTools) === null || _PDFViewerApplication26 === void 0 ? void 0 : _PDFViewerApplication26.switchTool(_pdf_cursor_tools.CursorTool.HAND);
        break;
      case 82:
        PDFViewerApplication.rotatePages(90);
        break;
...
class PDFPageView {
  constructor(options) {
    ...
    this.l10n.get("page_landmark", {
      ...
      _div.setAttribute("aria-label", msg);
    });
    this.div = _div;
    _classPrivateMethodGet(this, _setDimensions, _setDimensions2).call(this);
    container === null || container === void 0 ? void 0 : container.append(_div);
  ...
  draw() {
    ...
    if (this.textLayer) {
      ...
      var _this$annotationLayer2, _this$annotationEdito2;
      const lastDivBeforeTextDiv = ((_this$annotationLayer2 = this.annotationLayer) === null || _this$annotationLayer2 === void 0 ? void 0 : _this$annotationLayer2.div) || ((_this$annotationEdito2 = this.annotationEditorLayer) === null || _this$annotationEdito2 === void 0 ? void 0 : _this$annotationEdito2.div);
...
var _app = __webpack_require__(4);
var _document$blockUnbloc, _document;
const pdfjsVersion = '3.2.121';
const pdfjsBuild = 'a749f6cc1';
const AppConstants = {
